...
from lib.utils.blob import prep_im_for_blob, im_list_to_blob, im_list_to_reflect_blob
...
def get_minibatch(roidb, num_classes):
    ...
    im_blob, reflect_blob,im_scales = _get_image_blob(roidb, random_scale_inds)

    blobs = {'data': im_blob, 'reflect': reflect_blob}
...
def _get_image_blob(roidb, scale_inds):
    ...
    reflect_blob = im_list_to_reflect_blob(processed_ims)

    return blob, reflect_blob, im_scales
